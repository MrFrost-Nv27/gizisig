...
class AuthMigration extends Migration
{
    ...
    public function up(): void
    {
        ...
        $this->forge->addField([
            ...
            'picture' => ['type' => 'varchar', 'constraint' => 256, 'default' => 'https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w=740&t=st=1685421850~exp=1685422450~hmac=eb42cbd8af487fbbbd99b365d786a5de743cc58fd7e31cdcfd0367ae97fdcd71'],
        ...
        $this->forge->addField([
            ...
            'user_id' => ['type' => 'char', 'constraint' => 36, 'null' => true], // Only for successful logins
            'date' => ['type' => 'datetime'],
